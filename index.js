...
const token = "ODMwNDAwMTk4NjYwMTk0MzI1.YHGIcw.h13wYbEECrnjZYXN5GzWEE8Owa8"
const {prefix, channelid, matn, matngoodbe, channelid2} = require(`./bot.json`);
...
let targetguild = client.guilds.cache.get("828658962999148584")
    let hungry = [`${targetguild.memberCount} members`, "𝑳𝒐𝒔𝒂𝒏𝒈𝒆𝒍𝒆𝒔 FAMILY │ discord.gg/EFMRAhGkjA"]
  ...
  function chNickname() {
    ...
    let name = ["𝑳" , "𝑳𝒐" , "𝑳𝒐𝒔" , "𝑳𝒐𝒔𝒂" , "𝑳𝒐𝒔𝒂𝒏" , "𝑳𝒐𝒔𝒂𝒏𝒈" , "𝑳𝒐𝒔𝒂𝒏𝒈𝒆" , "𝑳𝒐𝒔𝒂𝒏𝒈𝒆𝒍" , "𝑳𝒐𝒔𝒂𝒏𝒈𝒆𝒍𝒆" , "𝑳𝒐𝒔𝒂𝒏𝒈𝒆𝒍𝒆𝒔" ]
...
<a:818177881036947466:831562255392964639> │%info -> Darbare family Losangeles
...
<a:818177881036947466:831562255392964639> │ %dargah -> Link Dargah Losangeles family
...
<a:loading34:830519772126511164> │ *invite -> invite Dadan Losangeles FAMILY Bot Be Server Khodeton
...
<a:5106verifyblack:831513383815217203> │Agar Moshkeli Dashtid Mitonid Ticket Baz Konid`)
   welcomeEmbed3.setFooter(`بات توسط تیم لوس  آنجلس فمیلی ساخته شده است`)
          message.channel.send(welcomeEmbed3)
      }
     });
    // client.on('message', message => {
...
//if (!message.member.hasPermission("ADMINISTRATOR"))
 ...
 // **<a:6234_nitro_booster_s:831772126385143878> │ Nitro**
  ...
  // <a:816812038499991602:831566053015552000>  | Nitro Mojod Nist , Dar Soorat Mojodi Dar Announce Elam Mishavad`)
   //welcomeEmbed3.setFooter(`ممبر های سرور${message.guild.memberCount}`)
         // message.channel.send(welcomeEmbed3)
    //  }
//});
...
//if (!message.member.hasPermission("ADMINISTRATOR"))
    ...
    // welcomeEmbed.setThumbnail()
   welcomeEmbed3.setDescription(`[**<a:818185041968365639:831739862369304596> | Losangeles FAMILY Id Pay**]( https://idpay.ir/losangeles-shop)`)
   //welcomeEmbed3.setFooter(`ممبر های سرور${message.guild.memberCount}`)
          message.channel.send(welcomeEmbed3)
      }
});
  ...
  client.on('message', message => {
    if (message.content.toLowerCase() === `${prefix}server`) {
      const embed = new Discord.MessageEmbed()
        ...
        .setDescription(`** <a:8809_nitro:831772126507040778> | Server Info**
        
        **<a:818185041968365639:831739862369304596> | Owner**
        Kale Gonde Ye In Server:  ${message.guild.owner}
        
        **<a:818185064411955210:831566077263740950> | Members**
        Tedad Aza server: ${message.guild.memberCount} members
        
        **<a:6234_nitro_booster_s:831772126385143878> | Tedad Emoji Ha**
        In Server Daraye: ${message.guild.emojis.cache.size} emoji Hast
        
        **<a:818177881036947466:831562255392964639> | Tedad Role Ha**
        in Server: ${message.guild.roles.cache.size} role Dard
        
        region
        region in server : ${message.guild.region}
        
        age channel count: ${message.guild.agecount}
